    ...
    <div className="bg-slate-50 min-h-screen pt-24">
      ...
      <div className="relative h-[400px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white mb-4 drop-shadow-2xl">The <span className="text-orange-400">Travel Blog</span></h1>
          <p className="text-slate-200 text-lg md:text-xl max-w-2xl mx-auto font-medium">Stories, tips, and guides from our global community of explorers.</p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
           ...
           {isLoggedIn && (
             <button
               ...
               className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold text-sm hover:bg-orange-600 transition-all shadow-xl shadow-slate-200 hover:shadow-orange-100 uppercase tracking-widest"
             >
               + Create New Post
             </button>
           )}
